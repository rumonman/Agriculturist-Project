...
const PrivacyPolicy = () => {
                ...
                <div id="content-wrapper" className="d-flex flex-column">
                    <div id="content">
                        <div className="policy">
                            <h2>Agriculturist-World Intelligentsia Network > Privacy Policy</h2>
                            <hr />
                            <p>
                            Irita Information Technology Ltd built the Agriculturist-World Intelligentsia 
                            Network app as a Free app. This SERVICE is provided by Irita Information 
                            Technology Ltd at no cost and is intended for use as is.
                            </p>

                            <p>This page is used to inform visitors 
                            ...
                            accessible at Agriculturist-World Intelligentsia 
                            Network unless otherwise defined in this Privacy Policy. 
                            </p>
                            ...
                            identifiable information, including but not limited to agriculture, 
                            social network, agricultural professional. The information that we 
                            request will be retained by us and used as described in this privacy policy.
                            </p>

                            <p>The app does use third-party services that 
                            may collect information used to identify you.
                            </p>

                            <p>Link to the privacy policy of third-party service
   ...
   <h4>Cookies </h4>
    ...
    <p> Cookies are files with a small amount of 
 ...
 <p>We may employ third-party 
 companies and individuals due to 
...
do not hesitate to contact us at <strong>iritainformationtechnology@gmail.com.</strong>
</p>
                        </div>
                    </div>
                    <Footer />
